   ...
   for (const simp of simpsons){
        ...
        div.innerText = `${simp.name} - ${simp.surname} - ${simp.info}`;
    ...
    for (const simp of simpsons){
        ...
        divName.innerText = simp.name;

        let divSurName = document.createElement('div');
        divSurName.innerText = simp.surname;

        let divAge = document.createElement('div');
        divAge.innerText = simp.age;

        let divInfo = document.createElement('div');
        divInfo.innerText = simp.info;

        let divPhoto = document.createElement('img');
        divPhoto.src = simp.photo;

        document.body.append(divName,divSurName,divAge,divInfo,divPhoto);
    ...
    for (let item of coursesArray){
        ...
        monthDiv.textContent = item.monthDuration;
        hourDiv.textContent = item.hourDuration;
        ...
        durationDiv.appendChild(hourDiv);
        itemDiv.append(titleDiv, durationDiv, modulesUl);
